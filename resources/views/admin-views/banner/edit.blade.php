                        ...
                        <form action="{{ route('admin.banner.update', [$banner['id']]) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    @if ($banner['banner_type'] == 'Home Category Banner')
                                        <div class="form-group mb-3" id="banner_sequence">
                                            ...
                                            <input type="number" name="sequence" class="form-control" id="sequence" placeholder="{{ translate('Enter_sequence') }}" value="{{ $banner['sequence'] }}">
                                        </div>
                                    @endif
