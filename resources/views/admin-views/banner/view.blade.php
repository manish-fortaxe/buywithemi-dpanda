                        ...
                        <form action="{{ route('admin.banner.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3" id="banner_sequence">
                                        <label for="name" class="title-color text-capitalize">{{ translate('banner_sequence') }}</label>
                                        <input type="number" name="sequence" class="form-control" id="sequence" placeholder="{{ translate('Enter_sequence') }}">
                                    </div>
