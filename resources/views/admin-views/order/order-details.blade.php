                    ...
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    ...
                                                    <div>
                                                        <h6 class="title-color">{{$productDetails->name}}</h6>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                ...
                                @if (isset($order->orderTransaction->convenience_fee) && $order->orderTransaction->convenience_fee > 0)
                                    <span class="badge badge-soft-info w-100">
                                        Convenience Fee = ₹{{ $order->orderTransaction->convenience_fee }}
                                    </span>
                                @endif
                            </div>
                        </div>
