                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/pricing*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               title="{{translate('pricing')}}" href="{{route('admin.pricing.index')}}">
                                <i class="tio-money nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('pricing')}}</span>
                            </a>
                        </li>
                        ...
                        @if(Helpers::module_permission_check('promotion_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/abandoned-cart*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.abandoned-cart.list')}}" title="{{translate('abndoned_cart')}}">
                                    <i class="tio-shopping-cart nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('abndoned_cart')}}</span>
                                </a>
                            </li>
