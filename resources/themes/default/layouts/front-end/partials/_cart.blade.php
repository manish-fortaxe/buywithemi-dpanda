<div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
    ...
    @else
        <a class="navbar-tool-icon-box  dropdown-toggle" href="{{ route('customer.auth.login') }}">
            ...
            <img src="{{ asset('myfigma/add-cart_icon.png') }}"  alt="Add To Cart" class="addtocart-icon">
        </a>
        <!---<a class="navbar-tool-text ms-2"
        ...
        <div class="widget widget-cart px-3 pt-2 pb-3">
            ...
            @if($cart->count() > 0)
                ...
                <div class="dropdown-saved-amount text-center  align-items-center justify-content-center text-accent mb-3 {{$totalSavedAmount <= 0 ? 'd-none' : 'd-flex'}}">
                    <img src="{{theme_asset(path: 'assets/front-end/img/party-popper.svg')}}" class="mr-2" alt="">
                ...
                @if ($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') !='free_delivery'))
                    <div class="py-3">
                        <img src="{{theme_asset(path: 'assets/front-end/img/truck.svg')}}" alt="">
                        <span
            ...
            @else
                <div class="widget-cart-item">
                    <div class="text-center text-capitalize">
                        <img class="mb-3 mw-100" src="{{theme_asset(path: 'assets/front-end/img/icons/empty-cart.svg')}}"
                             alt="{{ translate('cart') }}">
