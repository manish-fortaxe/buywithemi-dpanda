                                            ...
                                            <div class="">
                                                <div class="mt-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('alternate_phone')}}
                                                                    <span class="text-danger">*</span>
                                                                </label>
                                                                <input type="tel" class="form-control phone-input-with-country-picker-4" id="alternate_phone" {{$shippingAddresses->count()==0?'required':''}} >
                                                                <input type="hidden" id="shipping_phone_view" class="country-picker-phone-number-4 w-50" name="alternate_phone" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                        ...
                                                        {{-- <div class="col-12">
                                                            <div class="form-group mb-1">
                                                                <label>{{ translate('search_address')}}</label>
                                                                <input type='text' class="form-control" id="pac-input" title="{{translate('search_your_location_here')}}" placeholder="{{translate('search_here')}}" />
                                                            </div>
                                                        </div> --}}
                                                    </div>
                                            ...
                                            <div class="">
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('alternate_billing_phone')}}
                                                                    <span class="text-danger">*</span>
                                                                </label>
                                                                <input type="tel" class="form-control phone-input-with-country-picker-5" id="alternate_billing_phone" {{$shippingAddresses->count()==0?'required':''}} >
                                                                <input type="hidden" id="shipping_phone_view" class="country-picker-phone-number-5 w-50" name="alternate_billing_phone" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" name="billing_email" id="billing_email" {{$shippingAddresses->count()==0?'required':''}} >
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
