...
class BannerController extends BaseController
{
    ...
    public function getListView(Request $request): View
    {
        ...
        // $categories = $this->categoryRepo->getListWhere(filters: ['position'=>0], dataLimit: '10');
        // $shops = $this->shopRepo->getListWithScope(scope:'active', dataLimit: 'all');
        // $brands = $this->brandRepo->getListWhere(dataLimit: '10');
        // $products = $this->productRepo->getListWithScope(scope:'active', dataLimit: '20');
        return view(Banner::LIST[VIEW],  compact('banners',  'bannerTypes'));
    ...
    public function getUpdateView($id): View
    {
        ...
        // $brands = $this->brandRepo->getListWhere(dataLimit: '10');
        // $products = $this->productRepo->getListWithScope(scope:'active', dataLimit: '20');
        return view(Banner::UPDATE[VIEW], compact('banner',  'bannerTypes'));
    }
