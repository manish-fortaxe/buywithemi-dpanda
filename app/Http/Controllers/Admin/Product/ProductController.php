...
class ProductController extends BaseController
{
    ...
    public function getListView(Request $request, string $type): View
    {
        ...
        // Search by name if search value is provided
        ...
        $sellers = null;
        $brands = $this->brandRepo->getListWhere(filters: ['status' => 1], dataLimit: '30');
        $categories = $this->categoryRepo->getListWhere(filters: ['position' => 0], dataLimit: 'all');
        ...
        return view(Product::LIST[VIEW], compact('products', 'sellers', 'brands', 'categories', 'subCategory', 'subSubCategory', 'type'));
    }
