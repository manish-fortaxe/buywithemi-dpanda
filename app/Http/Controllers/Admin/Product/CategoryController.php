...
class CategoryController extends BaseController
{
    ...
    public function getAddView(Request $request): View
    {
        ...
        if($request->get('searchValue')){
            $categories = ModelsCategory::where('name', 'like','%'.$request->get('searchValue').'%')->paginate(getWebConfig(name: 'pagination_limit'));
        } else {
            $categories = ModelsCategory::paginate(getWebConfig(name: 'pagination_limit'));
        }
