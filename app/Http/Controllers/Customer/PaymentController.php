...
class PaymentController extends Controller
{
    ...
    public function payment(Request $request): JsonResponse|Redirector|RedirectResponse
    {
        ...
        // Check if payment_method_type is 'idfc_first'
        if ($request['payment_method_type'] === 'idfc_first') {
    ...
    {
        Log::info('web_payment_success -'.json_encode($request->all()));
    ...
    public function getCustomerPaymentRequest(Request $request, $orderAdditionalData = []): mixed
    {
        ...
        $order_id = 'BUYWITHEMI'.rand(000,999).time();
