...
use App\Http\Controllers\RestAPI\v1\KeepaProductController;
...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'keepa-products', 'middleware' => 'auth:api'], function () {
        Route::controller(KeepaProductController::class)->group(function () {
