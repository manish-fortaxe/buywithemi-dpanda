...
use App\Enums\ViewPaths\Admin\Pricing;
...
use App\Http\Controllers\Admin\Promotion\AbandonedCartController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'pricing', 'as' => 'pricing.'], function () {
        Route::controller(PricingController::class)->group(function () {
            Route::get(Pricing::VIEW[URI], 'index')->name('index');
        });
    });
    ...
    // Abandoned Cart
    Route::group(['prefix' => 'abandoned-cart', 'as' => 'abandoned-cart.','middleware'=>['module:promotion_management']], function () {
        Route::controller(AbandonedCartController::class)->group(function (){
            Route::get(AbandonedCart::LIST[URI], 'index')->name('list');
            Route::post(AbandonedCart::DELETE[URI], 'delete')->name('delete');
            Route::post(AbandonedCart::STATUS[URI], 'updateStatus')->name('status');
        });
    });
    ...
    Route::group(['prefix' => 'blog', 'as' => 'blog.','middleware'=>['module:promotion_management']], function () {
     ...
     // web.php (routes file)
     Route::post('/get-customer-products', [CartController::class, 'getCustomerProducts'])->name('getCustomerProducts');
