...
use App\Enums\ViewPaths\Web\Product;
use App\Enums\ViewPaths\Web\Review;
use App\Enums\ViewPaths\Web\UserLoyalty;
use App\Http\Controllers\Customer\JusPayWebhookController;
...
Route::any('juspay-webhook',[JusPayWebhookController::class,'receive_webhook']);
Route::controller(WebController::class)->group(function () {
    Route::get(Product::GOOGLE_MERCHANT_UPLOAD[URI],'google_merchant_upload')->name('google-merchant-upload');
});

//Shiprocket-webhook
Route::post('shiprocket-webhook',[WebhookController::class,'shiprocketWebhook']);
